...
ActiveRecord::Schema[7.0].define(version: 2022_11_25_164339) do
  ...
  create_table "motor_alert_locks", charset: "utf8", force: :cascade do |t|
  ...
  create_table "motor_alerts", charset: "utf8", force: :cascade do |t|
  ...
  create_table "motor_api_configs", charset: "utf8", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "motor_audits", charset: "utf8", force: :cascade do |t|
  ...
  create_table "motor_configs", charset: "utf8", force: :cascade do |t|
    t.string "key", null: false
  ...
  create_table "motor_dashboards", charset: "utf8", force: :cascade do |t|
  ...
  create_table "motor_forms", charset: "utf8", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
  ...
  create_table "motor_queries", charset: "utf8", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
  ...
  create_table "motor_resources", charset: "utf8", force: :cascade do |t|
    t.string "name", null: false
    t.text "preferences", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "motor_taggable_tags", charset: "utf8", force: :cascade do |t|
  ...
  create_table "motor_tags", charset: "utf8", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "scholars", charset: "utf8", force: :cascade do |t|
    t.string "full_name"
    t.text "bio"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "courses", "scholars"
